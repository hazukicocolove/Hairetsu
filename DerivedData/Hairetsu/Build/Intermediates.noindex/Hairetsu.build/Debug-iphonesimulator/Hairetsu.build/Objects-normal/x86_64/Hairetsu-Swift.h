...
#ifndef HAIRETSU_SWIFT_H
#define HAIRETSU_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Hairetsu",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8Hairetsu11AppDelegate")
...
SWIFT_CLASS("_TtC8Hairetsu13SceneDelegate")
...
SWIFT_CLASS("_TtC8Hairetsu14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, strong) IBOutlet UILabel * _Null_unspecified itsuLabel;
@property (nonatomic, strong) IBOutlet UILabel * _Null_unspecified dokodeLabel;
@property (nonatomic, strong) IBOutlet UILabel * _Null_unspecified daregaLabel;
@property (nonatomic, strong) IBOutlet UILabel * _Null_unspecified doingLabel;
- (void)viewDidLoad;
- (IBAction)reset;
- (IBAction)change;
- (IBAction)random;
